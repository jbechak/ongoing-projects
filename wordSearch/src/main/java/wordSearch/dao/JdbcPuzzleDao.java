...
public class JdbcPuzzleDao implements PuzzleDao {
    ...
    public Puzzle getPuzzle(int puzzleId) {
        ...
        String sql = "select puzzle_id, title, description, difficulty, word_count, width, height, genre, instructions, creator, file_path from word_search where puzzle_id = ?;";
